...
import 'package:bloc_with_freezed/model/todo.dart';
...
class TodoListBloc extends Bloc<TodoListEvent, TodoListState> {
  ...
  void _onAddTodo(
    ...
    final newTodo = Todo(id: const Uuid().v4(), desc: todoDesc);
  ...
  void _onRemoveTodo(Emitter<TodoListState> emit, {required Todo todo}) {
